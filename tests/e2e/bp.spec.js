...
describe('BP Top 100', function() {
    ...
    describe('Extract JSON from BP, parse it and structure, top 100', function () {
    ...
    describe('Extract JSON from BP, parse it and structure, psy top 100', function () {
        let URLbase64 = 'aHR0cHM6Ly93d3cuYmVhdHBvcnQuY29tL2dlbnJlL3BzeS10cmFuY2UvMTMvdHJhY2tzP3BhZ2U9MSZwZXJfcGFnZT0xMDAmcHJlb3JkZXJzPWZhbHNl';
        let URLRaw = new Buffer(URLbase64, 'base64').toString('ascii'); // decode
        ...
        it('Extract chart BP data', async function () {
            ...
            let sut = await parse({
                ...
                type: 'json',
                fields: {
                    id: 'props.pageProps.dehydratedState.queries.1.state.data.results.{Iterator}.id',
                    ...
                    duration: 'props.pageProps.dehydratedState.queries.1.state.data.results.{Iterator}.length',
                    date: 'props.pageProps.dehydratedState.queries.1.state.data.results.{Iterator}.new_release_date',
                    image: 'props.pageProps.dehydratedState.queries.1.state.data.results.{Iterator}.release.image.uri',
                },
            });
